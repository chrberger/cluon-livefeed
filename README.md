...
```
docker run --rm -ti --init --net=host chrberger/cluon-livefeed-multi:v0.0.56 --cid=111
```
...
```
docker run --rm -ti --init --net=host -v $PWD:/opt chrberger/cluon-livefeed-multi:v0.0.56 --cid=111 --odvd=/opt/example.odvd
```
